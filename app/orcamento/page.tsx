...
const BudgetPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    // Opção de hospedagem
    includeHosting: !searchParams.get('noHosting')
  });
  ...
  useEffect(() => {
    if (searchParams.get('service')) {
      ...
      const model = getModelById(serviceType);
      if (model) {
        ...
        const finalFeatures = searchParams.get('noHosting') === 'true'
        ...
        setFormData(prevState => ({
          ...
          includeHosting: searchParams.get('noHosting') !== 'true'
        }));
      }
    }
  }, [searchParams]);

  // Atualizar features quando o tipo de projeto muda
  useEffect(() => {
  ...
  }, [formData.projectType, formData.includeHosting]);
