    ...
    const fetchPortfolioItems = async () => {
      try {
        ...
        const enrichedItems = data.map((item: PortfolioItem) => ({
          ...
          technologies: item.technologies || defaultTechnologies[item.category as keyof typeof defaultTechnologies] || defaultTechnologies['Website'],
          features: item.features || defaultFeatures[item.category as keyof typeof defaultFeatures] || defaultFeatures['Website'],
        }));
        ...
        setPortfolioItems([
          {
            ...
            description: 'Site institucional moderno com animações suaves, design responsivo e integração com CMS para gestão de conteúdo. Inclui blog, área de notícias e integração com redes sociais.',
